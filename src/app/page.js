  ...
  return (
    <main className="relative z-10 min-h-screen px-4 py-4 sm:px-6 sm:py-6">
      ...
      <section className="mx-auto max-w-[1480px] py-6 sm:py-10">
        <div className="mb-7 flex flex-col items-start justify-between gap-5 lg:flex-row lg:gap-8">
          <div>
          ...
          {session && (
            <a
              ...
              className="group inline-flex items-center gap-3 rounded-full bg-[#ff5a1f] px-5 py-3 text-xs font-bold uppercase tracking-[0.12em] text-white shadow-[0_14px_35px_rgba(255,90,31,0.28)] transition duration-300 hover:-translate-y-1 hover:bg-[#f04f18] hover:shadow-[0_18px_45px_rgba(255,90,31,0.42)] sm:mt-5 sm:px-6 sm:py-3.5 sm:text-sm"
            >
              REQUEST TRAINING
              <ArrowUpRight
                size={18}
        ...
        <div className="mb-7 flex flex-col items-center">
          ...
          <div className="mb-4 flex flex-col items-center justify-center gap-1 text-center sm:flex-row sm:items-baseline sm:gap-4">
        ...
        <div className="mb-5 flex items-center gap-8 overflow-x-auto border-b border-[#dddbd6]">
  <button className="shrink-0 border-b-4 border-[#ff5a1f] pb-3 text-sm font-black sm:text-base">
    all sessions{" "}
