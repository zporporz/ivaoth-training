      ...
      <section className="mx-auto max-w-[1480px] py-10">
        <div className="mb-8">
          ...
          <h1 className="mt-3 text-5xl font-black tracking-[-0.04em]">
            <span className="font-normal italic text-[#4b4b48]">Manage</span>{" "}
            training list<span className="text-[#ff5a1f]">.</span>
          </h1>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <Card className="overflow-hidden p-0">
            ...
            <div>
              {staffList.map((staff) => (
                <div key={staff.firestoreId} className="grid grid-cols-[1fr_180px] items-center gap-4 border-b border-[#ececea] px-6 py-5">
                  <div>
                    ...
                    {staff.avatarUrl && (
                      <div className="mt-1 text-xs font-black text-[#8b8a84]">{staff.avatarUrl}</div>
                    )}
                  </div>
